...
class Cell:
    ...
    def __add__(self, other):
        self.other = other
        return f'сумма {self.cell + self.other}'

    def __sub__(self, other):
        self.other = other
        if self.cell > self.other:
            return f'разность - {self.cell - self.other}'
        else:
            return f'разность меньше нуля'

    def __mul__(self, other):
        self.other = other
        return f'умножение{self.cell * self.other}'

    def __truediv__(self, other):
        self.other = other
        return f'деление{self.cell // self.other}'
